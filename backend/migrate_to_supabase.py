...
Script pour migrer toutes les données de MySQL vers Supabase
"""
...
SUPABASE_URL = input("Entrez votre DATABASE_URL Supabase: ").strip()
...
try:
    ...
    print("3. Tester la connexion avec vos utilisateurs existants\n")
    ...
    pg_conn.rollback()
    print("✅ Rollback effectué, aucune donnée n'a été modifiée\n")
